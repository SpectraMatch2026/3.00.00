...
var I18n = {
    ...
    translations: {
        en: {
            ...
            'thesis.web.modal.badge': 'Thesis Edition',
            'thesis.web.modal.title': 'SpectraMatchTez3.0.0',
            'thesis.web.modal.body': 'This web build is the <strong>SpectraMatchTez3.0.0</strong> thesis edition. For the complete workflow, please download the desktop version.',
            'thesis.web.modal.download': 'Download Desktop',
            ...
            'color.methods.desc': 'ΔE₀₀ is always calculated. CMC is optional for textile industry compliance.',
            ...
            'thresholds.delta.e': 'Thresholds (ΔE<sub>00</sub>)',
            ...
            'csi.thresholds.desc': 'CSI uses full-image pixel-by-pixel ΔE₀₀ across the reference and sample images.',
            'csi.norm.threshold': 'CSI',
            'csi.norm.threshold.hint': 'Full-image pixel-by-pixel ΔE₀₀ metric.',
            'csi.good.threshold': 'CSI Pass Threshold',
            'above.this.green': 'At or below this = Pass',
            'csi.warning.threshold': 'CSI Conditional Threshold',
            'above.this.orange': 'At or below this = Conditional',
            ...
            'coord.entry.title': 'Add Point by Coordinates',
            'coord.entry.desc': 'Enter X and Y pixel coordinates to add a sampling point manually.',
            'coord.x': 'X',
            'coord.y': 'Y',
            'coord.add': 'Add',
            'coord.added.points': 'Entered Points',
            'coord.no.points': 'No coordinate points added yet.',
            'coord.clear.all': 'Clear All',
            'coord.invalid': 'Invalid coordinates. Check values and image dimensions.',
            'coord.duplicate': 'A point at these coordinates already exists.',
            'coord.limit.reached': 'Sampling point limit reached.',
            'coord.outside.region': 'Point is outside the selected region.',
            'coord.point.added': 'Point added',
            'coord.point.removed': 'Point removed',
            ...
            'define.similarity.scores': 'Define per-method thresholds for pattern analysis. SSIM uses raw 0-1 values.',
            ...
            'visual.comparison.section': 'Visual Comparison',
            ...
            'sensitivity.diff.title': 'Difference Sensitivity (1 \u2013 10)',
            'sensitivity.diff.desc': 'Controls how aggressively the difference map amplifies subtle variations. Higher values reveal finer differences; lower values suppress noise.',
            'sensitivity.grad.diff': 'Gradient Diff Sensitivity',
            'sensitivity.phase.diff': 'Phase Diff Sensitivity',
            'sensitivity.bound.title': 'Boundary Extraction Sensitivity (1 \u2013 10)',
            'sensitivity.bound.desc': 'Controls how aggressively boundary contours are extracted from the difference map. Higher values detect more subtle boundary regions; lower values show only obvious defects.',
            'sensitivity.grad.bound': 'Gradient Boundary Sensitivity',
            'sensitivity.phase.bound': 'Phase Boundary Sensitivity',
            'sensitivity.hint.strict.permissive': '1 = strict, 10 = permissive',
            'sensitivity.structural.title': 'Structural Sensitivity (1 \u2013 10)',
            'sensitivity.structural.desc': 'Controls how aggressively the multi-method structural difference pipeline detects changes. Higher values flag subtle variations; lower values only flag obvious defects.',
            'sensitivity.structural': 'Structural Sensitivity',

            // Detailed Results Panel
            'rpt.report.summary': 'Report Summary',
            'rpt.color.scoring': 'Color Scoring',
            'rpt.pattern.scoring': 'Pattern Scoring',
            'rpt.csi.color.similarity': 'CSI (full-image ΔE₀₀)',
            'rpt.avg.lab.distance': 'Avg Lab Distance',
            'rpt.csi.distribution.distance': 'CSI',
            'rpt.csi.norm.threshold': 'CSI',
            'rpt.csi.note': 'CSI is the full-image pixel-by-pixel ΔE₀₀ between the reference and sample images.',
            'rpt.pixel.count': 'Pixel Count',
            'rpt.mean.de2000': 'Mean ΔE₀₀',
            ...
            'rpt.changed.pixels': 'Changed Pixels',
            ...
            'rpt.changed.area': 'Changed Area',
            'rpt.weighted.severity': 'Weighted Severity',
            'rpt.detected.regions': 'Detected Regions',
            ...
            'cam.import.computer': 'Import from Computer',
            'cam.import.camera': 'Import from Camera',
            'cam.studio.title': 'Camera Capture Studio',
            'cam.select.camera': 'Select Camera',
            'cam.no.cameras': 'No cameras detected',
            'cam.requesting': 'Requesting camera access...',
            'cam.permission.denied': 'Camera permission denied. Please allow camera access in your browser settings.',
            'cam.not.supported': 'Camera is not supported in this browser.',
            'cam.capture': 'Capture',
            'cam.retake': 'Retake',
            'cam.use.image': 'Use Image',
            'cam.cancel': 'Cancel',
            'cam.close': 'Close',
            'cam.rotate.left': 'Rotate Left',
            'cam.rotate.right': 'Rotate Right',
            'cam.flip.h': 'Flip Horizontal',
            'cam.brightness': 'Brightness',
            'cam.contrast': 'Contrast',
            'cam.crop.hint': 'Drag to crop the captured image',
            'cam.for.reference': 'Use as Reference',
            'cam.for.sample': 'Use as Sample',
            'cam.captured': 'Image captured successfully',
            'cam.assigned.ref': 'Captured image set as Reference',
        ...
        tr: {
            ...
            'thesis.web.modal.badge': 'Tez Sürümü',
            'thesis.web.modal.title': 'SpectraMatchTez3.0.0',
            'thesis.web.modal.body': 'Bu web sürümü <strong>SpectraMatchTez3.0.0</strong> tez sürümüdür. Tam kullanım için lütfen masaüstü sürümünü indiriniz.',
            'thesis.web.modal.download': 'Masaüstünü İndir',
            ...
            'color.methods.desc': 'ΔE₀₀ her zaman hesaplanır. CMC tekstil endüstrisi uyumluluğu için isteğe bağlıdır.',
            ...
            'thresholds.delta.e': 'Eşikler (ΔE<sub>00</sub>)',
            ...
            'csi.thresholds': 'CSI Eşikleri',
            'csi.thresholds.desc': 'CSI, referans ve numune görüntülerinin tamamında piksel bazlı ΔE₀₀ olarak hesaplanır.',
            'csi.norm.threshold': 'CSI',
            'csi.norm.threshold.hint': 'Tam görüntü piksel bazlı ΔE₀₀ metriği.',
            'csi.good.threshold': 'CSI geçiş eşiği',
            'above.this.green': 'Buna eşit veya altı = Geçti',
            'csi.warning.threshold': 'CSI koşullu eşiği',
            'above.this.orange': 'Buna eşit veya altı = Koşullu',
            ...
            'coord.entry.title': 'Koordinatla Nokta Ekle',
            'coord.entry.desc': 'Örnekleme noktasını manuel olarak eklemek için X ve Y piksel koordinatlarını girin.',
            'coord.x': 'X',
            'coord.y': 'Y',
            'coord.add': 'Ekle',
            'coord.added.points': 'Girilen Noktalar',
            'coord.no.points': 'Henüz koordinat noktası eklenmedi.',
            'coord.clear.all': 'Tümünü Temizle',
            'coord.invalid': 'Geçersiz koordinatlar. Değerleri ve görüntü boyutlarını kontrol edin.',
            'coord.duplicate': 'Bu koordinatlarda zaten bir nokta mevcut.',
            'coord.limit.reached': 'Örnekleme noktası sınırına ulaşıldı.',
            'coord.outside.region': 'Nokta seçili bölgenin dışında.',
            'coord.point.added': 'Nokta eklendi',
            'coord.point.removed': 'Nokta kaldırıldı',
            ...
            'define.similarity.scores': 'Desen analizi için yöntem eşiklerini tanımlayın. SSIM ham 0-1 değerlerini kullanır.',
            ...
            'visual.comparison.section': 'Görsel Karşılaştırma',
            ...
            // Boundary Detection Sensitivity
            'sensitivity.diff.title': 'Fark Hassasiyeti (1 – 10)',
            'sensitivity.diff.desc': 'Fark haritasının ince varyasyonları ne kadar agresif güçlendireceğini kontrol eder. Yüksek değerler daha ince farkları ortaya çıkarır; düşük değerler gürültüyü bastırır.',
            'sensitivity.grad.diff': 'Gradyan Fark Hassasiyeti',
            'sensitivity.phase.diff': 'Faz Fark Hassasiyeti',
            'sensitivity.bound.title': 'Sınır Çıkarım Hassasiyeti (1 – 10)',
            'sensitivity.bound.desc': 'Sınır konturlarının fark haritasından ne kadar agresif çıkarılacağını kontrol eder. Yüksek değerler daha ince sınır bölgelerini tespit eder; düşük değerler yalnızca belirgin kusurları gösterir.',
            'sensitivity.grad.bound': 'Gradyan Sınır Hassasiyeti',
            'sensitivity.phase.bound': 'Faz Sınır Hassasiyeti',
            'sensitivity.hint.strict.permissive': '1 = katı, 10 = esnek',
            'sensitivity.structural.title': 'Yapısal Hassasiyet (1 – 10)',
            'sensitivity.structural.desc': 'Çok yöntemli yapısal fark hattının değişiklikleri ne kadar agresif tespit edeceğini kontrol eder. Yüksek değerler ince varyasyonları işaretler; düşük değerler yalnızca belirgin kusurları işaretler.',
            'sensitivity.structural': 'Yapısal Hassasiyet',

            // Detailed Results Panel
            'rpt.report.summary': 'Rapor Özeti',
            'rpt.color.scoring': 'Renk Puanlama',
            'rpt.pattern.scoring': 'Desen Puanlama',
            'rpt.csi.color.similarity': 'CSI (tam görüntü ΔE₀₀)',
            'rpt.avg.lab.distance': 'Ortalama Lab mesafesi',
            'rpt.csi.distribution.distance': 'CSI',
            'rpt.csi.norm.threshold': 'CSI',
            'rpt.csi.note': 'CSI, referans ve numune görüntülerinin tamamı üzerinde piksel bazlı ΔE₀₀ farkıdır.',
            'rpt.pixel.count': 'Piksel Sayısı',
            'rpt.mean.de2000': 'Ortalama ΔE₀₀',
            ...
            'rpt.changed.pixels': 'Değişen Piksel',
            ...
            'rpt.changed.area': 'Değişen Alan',
            'rpt.weighted.severity': 'Ağırlıklı Şiddet',
            'rpt.detected.regions': 'Tespit Edilen Bölgeler',
            ...
            // Camera Capture Studio
            'cam.import.computer': 'Bilgisayardan İçe Aktar',
            'cam.import.camera': 'Kameradan İçe Aktar',
            'cam.studio.title': 'Kamera Yakalama Stüdyosu',
            'cam.select.camera': 'Kamera Seçin',
            'cam.no.cameras': 'Kamera algılanmadı',
            'cam.requesting': 'Kamera erişimi isteniyor...',
            'cam.permission.denied': 'Kamera izni reddedildi. Lütfen tarayıcı ayarlarından kamera erişimine izin verin.',
            'cam.not.supported': 'Bu tarayıcıda kamera desteklenmiyor.',
            'cam.capture': 'Yakala',
            'cam.retake': 'Yeniden Çek',
            'cam.use.image': 'Görüntüyü Kullan',
            'cam.cancel': 'İptal',
            'cam.close': 'Kapat',
            'cam.rotate.left': 'Sola Döndür',
            'cam.rotate.right': 'Sağa Döndür',
            'cam.flip.h': 'Yatay Çevir',
            'cam.brightness': 'Parlaklık',
            'cam.contrast': 'Kontrast',
            'cam.crop.hint': 'Yakalanan görüntüyü kırpmak için sürükleyin',
            'cam.for.reference': 'Referans Olarak Kullan',
            'cam.for.sample': 'Numune Olarak Kullan',
            'cam.captured': 'Görüntü başarıyla yakalandı',
            'cam.assigned.ref': 'Yakalanan görüntü Referans olarak ayarlandı',
